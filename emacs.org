...
FEAT: Write ~gs-daemon/server~, see [[https://github.com/meow-edit/meow/issues/568][this]] issue.
...
** [[./notes/window_management.org][Window Management Bindings]]
...
*** [[https://github.com/karthink/gptel?tab=readme-ov-file#groq][Groq]]
...
*** [[https://lr.ggtyler.dev/r/emacs/comments/1benj4g/things_you_do_in_emacs_that_will_make_nonemacs/][wgrep export]]
...
#+begin_src emacs-lisp :tangle ./modules/gs-keys-meow.el :mkdirp yes
  ;;; -*- lexical-binding: t -*-
#+end_src
...
REFACTOR: require both catppuccin and daemonp to trigger this use-package declaration. `:if` seems to support only one function.
