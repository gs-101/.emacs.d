...
*** [[https://github.com/emacs-exwm/xdg-launcher][xdg-launcher]]
...
:PROPERTIES:
:CREDITS:  https://gitlab.com/dwt1/configuring-emacs/-/blob/main/07-the-final-touches/scripts/app-launchers.el?ref_type=heads
:END:
...
** [[https://codeberg.org/pale/pale][PALE]]
...
Tree-sitter based region interaction.
...
*** [[https://github.com/alexispurslane/treesit-sexp][treesit-sexp]]

Sexp interaction commands for Tree-Sitter based modes.
...
*** [[https://codeberg.org/slotThe/eglot-hover][Hover]]

More useful eglot messages. This gives more focus to type hints, for example.
...
*** [[https://github.com/taquangtrung/emacs-kdl-mode][KDL]]
...
*** [[https://codeberg.org/halvin/agitjo][AGitjo]]
...
*** [[https://codeberg.org/jao/consult-notmuch][Notmuch]]
...
** [[https://codeberg.org/emacs-weirdware/debase][Debase]]
...
*** [[https://codeberg.org/emacs-weirdware/discomfort][discomfort]]
...
** [[https://codeberg.org/rstocker/emacs-bluetooth][Emacs Bluetooth Mode]]
...
*** [[https://github.com/xenodium/dwim-shell-command#my-toolbox][Toolbox]]
...
** [[https://codeberg.org/rahguzar/filechooser][filechooser.el]]
...
** [[https://elpa.gnu.org/packages/pinentry.html][pinentry]]
...
*** [[https://github.com/tarsius/notmuch-transient][notmuch-transient]]
...
* LLMs
:PROPERTIES:
:header-args:emacs-lisp: :results none :lexical t :mkdirp yes :tangle ./modules/gs-llm.el
:END:
...
*** [[https://github.com/karthink/gptel-agent][agent]]
...
** [[https://github.com/LionyxML/auto-dark-emacs][Auto-Dark for Emacs]]
